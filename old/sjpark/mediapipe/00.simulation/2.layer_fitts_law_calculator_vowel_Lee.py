...
keyWidth = 1.0
# LEE keyboard layout (vowel to last layer)
layout = {'q': (0, 0, 0), 'b': (1, 0, 0), 'd': (2, 0, 0), 'g': (0, 1, 0), 'j': (1, 1, 0), 'm': (2, 1, 0), 'p': (0, 2, 0), 't': (1, 2, 0),  'w': (2, 2, 0), 'z': (0, 0, 1), 'c': (1, 0, 1), 'f': (2, 0, 1), 'h': (0, 1, 1), 'k': (1, 1, 1), 'n': (2, 1, 1), 'r': (0, 2, 1), 'v': (1, 2, 1), 'x': (2, 2, 1), 'a': (1, 0, 2), 'e': (2, 0, 2), 'i': (0, 1, 2), 'l': (1, 1, 2), 'o': (2, 1, 2), 's': (0, 2, 2), 'u': (1, 2, 2), 'y' : (2, 2, 2)}
