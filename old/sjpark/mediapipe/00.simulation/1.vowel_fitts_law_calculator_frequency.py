...
keyWidth = 1.0
# frequency keyboard layout
layout = {'a': (0, 0, 0), 'e': (1, 0, 0), 'i': (2, 0, 0), 'o': (0, 1, 0), 's': (1, 1, 0), 't': (2, 1, 0), 'n': (0, 2, 0), 'r': (1, 2, 0),  'h': (2, 2, 0), 'l': (0, 0, 1), 'd': (1, 0, 1), 'm': (2, 0, 1), 'p': (0, 1, 1), 'u': (1, 1, 1), 'c': (2, 1, 1), 'y': (0, 2, 1), 'f': (1, 2, 1), 'b': (2, 2, 1), 'v': (0, 0, 2), 'g': (1, 0, 2), 'k': (2, 0, 2), 'x': (1, 1, 2), 'w': (2, 1, 2), 'q': (0, 2, 2), 'j': (1, 2, 2), 'z':(2, 2, 2)}
