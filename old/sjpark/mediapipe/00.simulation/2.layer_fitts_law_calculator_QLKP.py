...
keyWidth = 1.0
# QLKP keyboard layout
layout = {'e': (0, 0, 0), 't': (1, 0, 0), 'o': (2, 0, 0), 'a': (0, 1, 0), 'r': (1, 1, 0), 'i': (2, 1, 0), 's': (0, 2, 0), 'h': (1, 2, 0),  'n': (2, 2, 0), 'q': (0, 0, 1), 'f': (1, 0, 1), 'p': (2, 0, 1), 'd': (0, 1, 1), 'g': (1, 1, 1), 'l': (2, 1, 1), 'c': (0, 2, 1), 'u': (1, 2, 1), 'm': (2, 2, 1), 'w':(0, 0, 2), 'y': (1, 0, 2), 'z': (0, 1, 2), 'v': (1, 1, 2), 'j': (2, 1, 2), 'x': (0, 2, 2), 'b': (1, 2, 2), 'k' : (2, 2, 2)}
