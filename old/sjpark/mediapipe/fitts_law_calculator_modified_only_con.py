...
keyWidth = 1.0
# ABC keyboard layout
layout = {'r': (0, 0, 0), 'n': (1, 0, 0), 't': (2, 0, 0), 's': (0, 1, 0), 'h': (1, 1, 0), 'f': (2, 1, 0), 'm': (0, 2, 0), 'p': (1, 2, 0),  'l': (2, 2, 0), 'd': (0, 0, 1), 'g': (1, 0, 1), 'c': (2, 0, 1), 'w': (0, 1, 1), 'j': (1, 1, 1), 'b': (2, 1, 1), 'x': (0, 2, 1), 'q': (1, 2, 1), 'y': (2, 2, 1), 'v': (0, 0, 2), 'z': (1, 0, 2), 'k': (2, 0, 2), 'o': (0, 1, 2), 'a': (1, 1, 2), 'u': (2, 1, 2), 'e': (0, 2, 2), 'i': (1, 2, 2)}
...
data_path = 'Ebook4_LesMiserables_alphabet_file.txt'
print(data_path)
